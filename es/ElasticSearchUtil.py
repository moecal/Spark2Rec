...
class ElasticSearchUtil:
    ...
    def searchDoc(self, index=None, type=None, body=None):
        ...
        :return:
        '''
        return self.conn.search(index=index, doc_type=type, body=body,size=10000,timeout='1m')
...
if __name__ == '__main__':
    ...
    # rs=esAction.searchDoc('demo11', 'test', query)
    # print(rs)
    # print(len(rs))
    # print(len(rs['hits']))
    # print(len(rs['hits']['hits']))
    # print(len(rs['hits']['hits']['_source']))
    ...
    # print(Elasticsearch([host]).__hash__())
    # print(Elasticsearch([host]).__hash__())
    es=Elasticsearch([host])
    print(datetime.datetime.now())

    es.bulk(index=_index,doc_type=_type, body=doc1,request_timeout=100)
    print(datetime.datetime.now())
    # es.bulk(index=_index, doc_type=_type, body=doc2,request_timeout=100)
    # print(datetime.datetime.now())
