...
if __name__ == '__main__':
    ...
    print(Elasticsearch(['120.27.241.54','120.27.243.224','114.55.226.34']).bulk(index=_index, doc_type=_type, body=doc,request_timeout=100))
    #
    # print(Elasticsearch(['120.27.241.54','120.27.243.224','114.55.226.34'],transport_class=transport.Transport()).bulk(index=_index, doc_type=_type, body=doc,request_timeout=100))
